...
function SponsorLogoPlaceholder({ label }: { label: string }) {
  return (
    <div
      ...
      className="flex h-35 w-full max-w-[278px] flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-artis-border bg-artis-white text-center xl:h-40 xl:w-[300px] xl:max-w-none"
    >
      <p className="text-sm font-semibold leading-5">
        Sponsor logo coming soon
      </p>
      <p className="text-xs font-medium leading-[18px] tracking-[0.2px] text-artis-slate">
      ...
      <main className="bg-artis-white">
        <section className="mx-auto w-full max-w-[1280px] px-6 pt-10 pb-12 xl:px-0 xl:py-18">
          ...
          <section className="mt-6 bg-artis-soft-gold p-6 xl:mt-7 xl:p-10">
            <h2 className="text-[22px] font-semibold leading-[30px] xl:text-[36px] xl:font-bold xl:leading-11 xl:tracking-[-1px]">
              Interested in supporting ARTIS Soccer Academy?
            </h2>
            <p className="mt-3.5 text-base leading-[26px] text-artis-slate xl:mt-4 xl:text-lg xl:leading-[30px]">
              Contact us to discuss sponsorship opportunities.
            </p>
            <Link
              href="/contact?topic=sponsorship"
              className="mt-3.5 inline-flex min-h-12 w-full items-center justify-center rounded-[10px] bg-artis-navy px-6 py-3.5 text-center text-[15px] font-semibold leading-5 text-artis-white xl:mt-4 xl:w-[270px]"
            >
