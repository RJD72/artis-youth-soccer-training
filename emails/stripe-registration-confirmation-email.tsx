...
export type StripeRegistrationConfirmationEmailProps = Readonly<{
  guardianName: string;
  playerName: string;
...
export function StripeRegistrationConfirmationEmail({
  guardianName,
  playerName,
  trainingGroupName,
  programPackageName,
  ...
  trainingDates,
  registrationStatus,
}: StripeRegistrationConfirmationEmailProps) {
  return (
    <Html lang="en">
      <Head />

      <Preview>Registration confirmed for {playerName}</Preview>
        ...
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            ...
            <Text style={paragraphStyle}>
              Payment has been received and {playerName}&apos;s registration
              with ARTIS Soccer Academy is confirmed.
            </Text>
            ...
            <Text style={smallTextStyle}>
              Stripe will send a separate receipt for your card payment. Please
              keep this email for your registration records.
            </Text>

            <Text style={smallTextStyle}>
              If any of these details appear incorrect, contact ARTIS Soccer
              Academy.
            </Text>
          </Section>
...
export default StripeRegistrationConfirmationEmail;
