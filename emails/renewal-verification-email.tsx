...
export type RenewalVerificationEmailProps = {
  guardianName: string;
  playerName: string;
  renewalUrl: string;
  expiresAt: string;
...
export function RenewalVerificationEmail({
  guardianName,
  playerName,
  renewalUrl,
  expiresAt,
}: RenewalVerificationEmailProps) {
  return (
    <Html lang="en">
      <Head />
      <Preview>Review renewal options for {playerName}</Preview>
        ...
        <Container style={containerStyle}>
          <Section style={headerStyle}>
            ...
            <Heading as="h1" style={headingStyle}>
              Continue your player&apos;s training
            </Heading>
          </Section>
          ...
          <Section style={contentStyle}>
            ...
            <Text style={paragraphStyle}>
              ...
              Use the secure button below to continue.
            </Text>

            <Section style={buttonSectionStyle}>
              <Button href={renewalUrl} style={buttonStyle}>
            ...
            <Text style={linkContainerStyle}>
              <Link href={renewalUrl} style={linkStyle}>
                {renewalUrl}
              </Link>
            </Text>
            ...
            <Text style={smallTextStyle}>
              ...
              changes will be made without completing the renewal process.
            </Text>
          </Section>
...
export default RenewalVerificationEmail;
